...
from PyQt5.QtWidgets import (
    QApplication, QMainWindow, QWidget, QLabel, QFileDialog, QMessageBox,
...
class DisplayImage(QMainWindow):
    ...
    def setupWindow(self):
        ...
        """
        print(f'\nSetup window.')
        # Create 2 QLabels, one for original image and one for displaying example from OpenCV
        original_img_header = QLabel("Original Image")
        self.original_label = QLabel()
        # ? QLabel() -> setObjectName khac gi QLabel("...")
    ...
    def convertCVToQImage(self, image_file):
        """ Demonstrates how to load a cv imag and convert the image to Qt QImage. Displays the OpenCV image for comparison. Returns the converted QImage.
